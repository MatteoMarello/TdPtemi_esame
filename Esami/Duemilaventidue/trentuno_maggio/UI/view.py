...
class View(ft.UserControl):
    ...
    def load_interface(self):
        # title
        self._title = ft.Text("TdP 2024 - Esame 31/5/22", color="purple", size=24)
        ...
        self.ddQuartiere = ft.Dropdown(label="Quartiere", width=300)
        self.btnQuartieriAdiacenti = ft.ElevatedButton(text="Quartieri Adiacenti", width=200, on_click=self._controller.handleQuartieri)
        row2 = ft.Row([self.ddQuartiere, self.btnQuartieriAdiacenti], alignment=ft.MainAxisAlignment.CENTER)
