from Classroom.GestioneMeteo.database.DB_connect import DBConnect
from Classroom.GestioneMeteo.model.situazione import Situazione
...
class MeteoDao():
    ...
    @staticmethod
    def get_localita_umidita_media(mese):
        cnx = DBConnect.get_connection()
        result = []
        if cnx is None:
            print("Connessione fallita")
