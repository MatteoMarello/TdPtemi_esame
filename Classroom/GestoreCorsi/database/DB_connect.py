...
class DBConnect:
    ...
    #   DBConnect sarà una classe di cui esisterà una sola istaanza!

    def __init__(self):
        # Non bisogna creare istanze! Uso la classe come se fosse essa stessa l'unica istanza.
        raise RuntimeError('Do not create an instance, use the class method get_connection()!')

    # Uso il decoratore #classmethod: significa che questo è un metodo di classe! Quindi non riceve come primo parametro self
    # ma riceve il parametro cls! Significa che il metodo può accedere agli attributi di classe (nel nostro caso _cnxpool)!
    @classmethod
